...
collectionName = "healthcare_minor_consultation"
...
with gr.Blocks(theme=gr.themes.Base(),title="Q&A App : Doctor Consultation (Built on Open Source)") as demo:
    gr.Markdown(
        """
        # Q&A App : Doctor Consultation (Built on Open Source)
        """)
    textbox = gr.Textbox(label="Enter your question", value="What to do in case of seasonal allergies ?")
    with gr.Row():
